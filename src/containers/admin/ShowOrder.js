...
import { loginUser, getProductsCar, getCategories, getProducts, makeCheckout, getUsers, getOrders, getOrder, getItems, getItem } from '../../actions';
...
class ShowOder extends Component {
  constructor(props) {
    super(props);
    this.state = {
      total_price: 0,
          ...
          <div className="row">
            <div className="col-md-4 order-md-2 mb-4">
              <h4 className="d-flex justify-content-between align-items-center mb-3">
                ...
                <span className="badge badge-secondary badge-pill">{this.state.item ? this.state.item.length : '0'}</span>
              </h4>
                    ...
                    return (
                      <li key={item.id} className="list-group-item d-flex justify-content-between lh-condensed">
                        <div>
                          ...
                          <small className="text-muted">{thep.cantidad}</small>
                        </div>
...
function mapDispatchToProps(dispatch) {
  return bindActionCreators({ loginUser, getProductsCar, getProducts, getCategories, makeCheckout, getOrder, getOrders, getUsers, getItems, getItem }, dispatch);
}
export default connect(mapStateToProps, mapDispatchToProps)(ShowOder);
